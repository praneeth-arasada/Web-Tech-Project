...
import pic1  from './images/num1.jpg';
import pic2  from './images/num7.jpg';
...
export default class Leader extends Component{
    ...
    left(e){
        ...
        {var code=false}
        var user={id:window.data._id, s2:code}
        axios.post('http://localhost:9000/s2',user)
        .then(res=>{
    ...
    render(){
        ...
        return(
            ...
            <img src={pic2} style={{width:50, height:50 }} alt="picture missing" />
            <Myblock />
        </ div>
        )
    }
