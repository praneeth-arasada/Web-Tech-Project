...
import pic  from './images/num0.jpg';
import pic1  from './images/num9.jpg';
...
export default class Fir3 extends Component{
    ...
    left(e){
        ...
        {var code=true}
        var user={id:window.data._id, f3:code}
        axios.post('http://localhost:9000/f3',user)
        .then(res=>{
            console.log(res.data)
            window.data=res.data
            this.props.history.push('/game1/f2')   
        })
    }
    ...
    right(e){
        ...
        .then(res=>{
            console.log(res.data)
            window.data=res.data
            this.props.history.push('/game1/esc1')   
        })
    }
    ...
    render(){
        ...
        return(
            ...
            <img src={pic} style={{width:50, height:50 }} alt="picture missing" />
